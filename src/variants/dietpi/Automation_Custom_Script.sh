...
echo "_ADSBIM_BASE_VERSION=$(cat /opt/adsb/porttracker_sdr_feeder_install_metadata/version.txt)" >> "$ENV_FILE"
echo "_ADSBIM_CONTAINER_VERSION=$(cat /opt/adsb/porttracker_sdr_feeder_install_metadata/version.txt)" >> "$ENV_FILE"
